...
menubar.utils.terminal = config.applications.terminal -- Set the terminal for applications that require it
-- }}}
...
globalkeys = gears.table.join(
    ...
    -- Standard program
    awful.key({ modkey,           }, "Return", function () awful.spawn(config.applications.terminal) end,
