-- Plans:
--  hotkeys:
--    блокировка экрана (sock)
--  теги на обоих мониторах - очевидные названия вместо цифр
--  автозапуск программ на соответствующих тегах
--  внешний вид:
--    сменить обои
...
awful.screen.connect_for_each_screen(function(s)
    ...
    if screen_number > 2 then
        ...
        awful.tag(tags.names[screen_number], s, tags.layout[screen_number])
    end
